    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=120, unique=True, validators=[django.core.validators.RegexValidator(regex='[0][9][0-9]{9,9}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.CharField(blank=True, choices=[('diploma', 'دیپلم'), ('associate', 'کاردانی'), ('bachelor', 'کارشناسی'), ('master', 'کارشناسی ارشد'), ('phd', 'دکتری')], max_length=70, null=True)),
                ('cv', models.FileField(blank=True, null=True, upload_to='')),
                ('is_accepted', models.BooleanField(default=False)),
                ('favorite', models.ManyToManyField(blank=True, related_name='user', to='category.Favorite')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ManyToManyField(blank=True, related_name='groupteam', to=settings.AUTH_USER_MODEL)),
                ('owner', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='groupowner', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
