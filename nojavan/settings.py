"""
Django settings for nojavan project.
...
import os, logging, shutil, logging.config
...
MIDDLEWARE = [
    ...
    'nojavan.middleware.UserTrackerMiddleware',
]

ROOT_URLCONF = 'nojavan.urls'
...
WSGI_APPLICATION = 'nojavan.wsgi.application'
...
# CELERY_IMPORTS = ("user.tasks.hello", "user.tasks.send_email", )
